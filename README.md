...
|---|---|---|
| \`/start\` | Show the welcome message and instructions | \`/start\` |
| \`/track\` | Start tracking a new product — provide the product URL and your target price | \`/track https://www.amazon.com/dp/B0EXAMPLE 199.99\` |
| \`/list\` | View all products you're currently tracking, along with their IDs | \`/list\` |
| \`/remove\` | Stop tracking a specific product, using the ID shown in \`/list\` | \`/remove 3\` |
